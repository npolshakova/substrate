module github.com/agent-substrate/substrate/prototype-controlplane
...
replace github.com/agentgateway/agentgateway => ../../../../repos/agentgateway

replace github.com/agentgateway/agentgateway/api => ../../../../repos/agentgateway/api
